...
| 3D araç $C_d$ — V&V/UQ bandı | ⚠️ Bantlı | Model-form bandı (KARIŞIK: ölçüm + korunan öncül) — bluff %20.0 (ÖNCÜL — tek çapa %6.0 bandı daraltmadı), attached_2d %5.0 (ÖNCÜL — tek çapa %3.5 bandı daraltmadı) |
