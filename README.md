...
| 3D ince-kanatlı İHA — araç hattı GCI | ❌ Geçersiz geometri | ⚠ Bu üç kampanya kanadı DÜZ KUTU olan bir STL üzerinde koşuldu (shapely kurulu olmadığı için NACA ekstrüzyonu sessizce kutuya düşüyordu; 2026-07-27'de düzeltildi) — aerodinamik sayılar NACA2412'yi TEMSİL ETMEZ, yeniden koşulmalı. Mesh-yakınsama dersleri geçerli: (%226 → %517). GERÇEK ölçümle (rtree kurulduktan sonra) kanat hiçbir seviyede çözülmedi: yığın kalınlık/hücre standart 1.32×, hassas 3.39× — hedef ≥6. En ince özellik (firar kenarı ~2 mm) yüzey hücresinin 0.20 katı → 12 prizma katmanı ÖRÜLEMEDİ (mesh katmansızla birebir aynı, y⁺=4114). Cd=0.0272 yalnız basınç bileşeni; bu geometride snappy ile duvar-çözünür yol KAPALI |
