...
| 3D araç $C_d$ — V&V/UQ bandı | ⚠️ Bantlı | Model-form bandı (KARIŞIK: ölçüm + korunan öncül) — attached_2d %5.2 (n=1, ölçülen), bluff %8.2 (n=2, ÜST SINIR — hiçbir çapa model hatasını sayısal hatadan ayıramıyor), separated %12.0 (ÖNCÜL — tek çapa %10.5 bandı daraltmadı) |
...
| Ayrılmış akış — yeniden-yapışma uzunluğu (2D basamak) | ⚠️ Yalnız eğilim | Geriye-basamaklı akış ↔ Driver & Seegmiller 1985 (Re_H=37500): yeniden-yapışma kOmegaSST ile Xr/H=5.54 vs deney 6.26 → %-12; kEpsilon bu kurulumda sabit noktaya OTURMUYOR (20000 iterasyon, rezidüeller platoda). Duvar-çözünür aile (3 seviye, 102,400 hücre, y⁺tepe=0.048): Xr/H=5.605 → %-10.5, ayrıklaştırma bandı ±%2.39 — sapma bandtan BÜYÜK, model hatası sayısaldan ayrılabiliyor |
