...
| 3D araç $C_d$ — V&V/UQ bandı | ⚠️ Bantlı | Model-form bandı (KARIŞIK: ölçüm + korunan öncül) — attached_2d %12.0 (ÖNCÜL — tek çapa %2.8 bandı daraltmadı), bluff %9.3 (n=3, ÜST SINIR — hiçbir çapa model hatasını sayısal hatadan ayıramıyor), separated %25.0 (ÖNCÜL — tek çapa %8.8 bandı daraltmadı) |
