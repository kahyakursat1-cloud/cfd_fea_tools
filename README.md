...
| 3D ince-kanatlı İHA — araç hattı GCI | ❌ Yakınsamadı | MiniHawk (2026-07-28, DOĞRU geometri): 4 seviye 165,741→0.0006, 551,964→0.0377, 1,860,694→0.0139 — GCI %379, seri MONOTON DEĞİL → mesh bağımsızlığı YOK. En kaba seviye (51,034 hücre) fizik kapısında reddedildi (Cd=0). Ölçülen y⁺ ort **5399** (bant 30-300): düz levha çapasında ilk hücre sınır tabakayı yuttuğunda sürtünme %40 eksik ölçülmüştü, buradaki y⁺ daha da yüksek → SÜRTÜNME ÇÖZÜLMÜYOR. Cl=0.0143 oysa NACA2412 α=0'da ~0.25 — kamburluk hâlâ çözülmüyor; geometri artık doğru, sınır MESH ÇÖZÜNÜRLÜĞÜNDE (ince kanat ~1 mm hücre ister) |
