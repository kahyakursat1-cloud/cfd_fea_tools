...
| 3D araç $C_d$ — V&V/UQ bandı | ⚠️ Bantlı | Model-form bandı (KARIŞIK: ölçüm + korunan öncül) — attached_2d %5.0 (ÖNCÜL — tek çapa %3.5 bandı daraltmadı), bluff %8.2 (ölçülen, n=2) |
