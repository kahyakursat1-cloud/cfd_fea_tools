...
| 3D araç $C_d$ — V&V/UQ bandı | ⚠️ Bantlı | Ölçülen validasyon bandı — attached_2d %5.2 (n=1, ölçülen), bluff %8.2 (n=2, ÜST SINIR — hiçbir çapa model hatasını sayısal hatadan ayıramıyor) |
