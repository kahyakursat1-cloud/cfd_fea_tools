...
| 3D ince-kanatlı İHA — araç hattı GCI | ⚠️ Gösterilemedi | MiniHawk İHA, ÜÇ kampanya: standart GCI %226 (kanat/hücre 3.0×, hedef ≥6) → hassas_nl (3,943,330 hücre) kanat ÇÖZÜLDÜ (7.7×) ama y⁺=4114, sürtünme çözülmüyor (GCI %517) → hassas (12 katman) KATMAN ÇÖKTÜ: mesh katmansızla birebir aynı, y⁺ değişmedi. Cd=0.0272 yalnız basınç bileşeni. Bu geometride snappy ile duvar-çözünür yol KAPALI |
